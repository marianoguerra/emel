...
yystate(9, Ics, Line, Tlen, _, _) ->
    {10,Tlen,Ics,Line};
yystate(8, [36|Ics], Line, Tlen, Action, Alen) ->
...
-file("src/emel_lexer.xrl", 19).
yyaction_0(TokenChars, TokenLine) ->
     make_token (identifier, TokenLine, TokenChars) .

-compile({inline,yyaction_1/3}).
-file("src/emel_lexer.xrl", 20).
yyaction_1(TokenChars, TokenLen, TokenLine) ->
     build_string (string, TokenChars, TokenLine, TokenLen) .

-compile({inline,yyaction_2/2}).
-file("src/emel_lexer.xrl", 21).
yyaction_2(TokenChars, TokenLine) ->
     make_token (number, TokenLine, TokenChars, fun erlang : list_to_integer / 1) .

-compile({inline,yyaction_3/2}).
-file("src/emel_lexer.xrl", 23).
yyaction_3(TokenChars, TokenLine) ->
     make_token (id, TokenLine, tl (TokenChars)) .

-compile({inline,yyaction_4/2}).
-file("src/emel_lexer.xrl", 24).
yyaction_4(TokenChars, TokenLine) ->
     make_token (cls, TokenLine, tl (TokenChars)) .

-compile({inline,yyaction_5/2}).
-file("src/emel_lexer.xrl", 26).
yyaction_5(TokenChars, TokenLine) ->
     make_token (child, TokenLine, TokenChars) .

-compile({inline,yyaction_6/2}).
-file("src/emel_lexer.xrl", 27).
yyaction_6(TokenChars, TokenLine) ->
     make_token (parent, TokenLine, TokenChars) .

-compile({inline,yyaction_7/2}).
-file("src/emel_lexer.xrl", 28).
yyaction_7(TokenChars, TokenLine) ->
     make_token (sibling, TokenLine, TokenChars) .

-compile({inline,yyaction_8/2}).
-file("src/emel_lexer.xrl", 29).
yyaction_8(TokenChars, TokenLine) ->
     make_token (times, TokenLine, TokenChars) .

-compile({inline,yyaction_9/2}).
-file("src/emel_lexer.xrl", 30).
yyaction_9(TokenChars, TokenLine) ->
     make_token (openattr, TokenLine, TokenChars) .

-compile({inline,yyaction_10/2}).
-file("src/emel_lexer.xrl", 31).
yyaction_10(TokenChars, TokenLine) ->
     make_token (closeattr, TokenLine, TokenChars) .

-compile({inline,yyaction_11/2}).
-file("src/emel_lexer.xrl", 32).
yyaction_11(TokenChars, TokenLine) ->
     make_token (equal, TokenLine, TokenChars) .

-compile({inline,yyaction_12/2}).
-file("src/emel_lexer.xrl", 33).
yyaction_12(TokenChars, TokenLine) ->
     make_token (filter, TokenLine, TokenChars) .

-compile({inline,yyaction_13/0}).
-file("src/emel_lexer.xrl", 34).
yyaction_13() ->
     skip_token .
